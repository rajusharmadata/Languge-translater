...
const ResetPassword = () => {
  ...
  return (
    <div
      className="flex items-center justify-center h-screen bg-gradient-to-tl from-black via-gray-800 to-gray-900
"
    >
      <form
        onSubmit={handleSubmit}
        className="bg-gradient-to-tl from-black via-gray-800 to-gray-900
 p-6 rounded-2xl shadow-md w-96"
      >
