...
const VerifyOtp = () => {
  ...
  const isOtpfiled = otp.every((digit) => digit !== '');
      ...
      <div className="bg-gray-900/70 backdrop-blur-lg p-8 rounded-2xl shadow-lg border border-gray-700">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            ...
            className={
              isOtpfiled
                ? `w-full bg-gradient-to-tl from-black via-gray-800 to-gray-900
 text-white py-2.5 rounded-lg font-semibold hover:from-indigo-500 hover:to-blue-500 transition-all duration-300`
