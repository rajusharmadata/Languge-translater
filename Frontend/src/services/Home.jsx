        ...
        <section className='text-center py-20 px-6'>
          <div className='max-w-5xl mx-auto'>
            ...
            <p className='text-xl text-gray-200 max-w-3xl mx-auto leading-relaxed mb-12'>
              ...
              with our AI-powered platform. Translate words, sentences, and documents instantly with
              stunning accuracy and a mesmerizing interface.
            </p>
        ...
        <div className='max-w-6xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-300 max-w-2xl mx-auto'>
              Experience our intuitive interface that makes translation feel effortless and
              beautiful
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mt-20'>
            {[
              ...
              { icon: '⚡', title: 'Lightning Fast', desc: 'Get translations in milliseconds' },
              {
                icon: '🔒',
